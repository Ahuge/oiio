...
ifneq (${REDSDK_INCLUDE_DIR},)
MY_CMAKE_FLAGS += -DREDSDK_INCLUDE_DIR:STRING=${REDSDK_INCLUDE_DIR}
endif

ifneq (${REDSDK_LIBRARIES},)
MY_CMAKE_FLAGS += -DREDSDK_LIBRARIES:STRING=${REDSDK_LIBRARIES}
endif
